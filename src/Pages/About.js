...
const About = () => {
    ...
    return (
        <animated.div style={props} className="shadow about-content">
            <h1>About me</h1>
            <div className="icon"><a href="https://www.linkedin.com/in/lucas-schutz-208883143/" rel="noopener noreferrer" target="_blank"><i class="fab fa-linkedin"></i></a><a href="https://github.com/MOSvisio" rel="noopener noreferrer" target="_blank"><i class="fab fa-github"></i></a></div>
            <p> 
